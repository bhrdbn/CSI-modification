...
from datasets.cubloader import get_waterbird_dataset
...
WATERBIRDS_SUPERCLASS = list(range(2))
...
def get_dataset(P, dataset, test_only=False, image_size=None, download=True, eval=False):
    ...
    if dataset == 'cifar10':
        ...
        n_classes = 2
        train_set = trainset = get_waterbird_dataset(0.9, split='train')
        test_set = get_waterbird_dataset(0.9, split='test')
